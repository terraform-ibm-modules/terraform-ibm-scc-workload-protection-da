...
| <a name="input_profile_attachments"></a> [profile\_attachments](#input\_profile\_attachments) | SCC profile attachments. | `list(string)` | <pre>[<br>  "IBM Cloud Framework for Financial Services"<br>]</pre> | no |
