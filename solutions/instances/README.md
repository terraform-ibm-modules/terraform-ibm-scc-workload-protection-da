...
| <a name="input_attachment_profile_name"></a> [attachment\_profile\_name](#input\_attachment\_profile\_name) | Name of the SCC profile that is used for the attachment. | `string` | n/a | yes |
...
| <a name="input_attatchment_profile_version"></a> [attatchment\_profile\_version](#input\_attatchment\_profile\_version) | Version of the SCC profile that is used for the attachment. | `string` | n/a | yes |
