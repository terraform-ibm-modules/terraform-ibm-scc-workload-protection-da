...
| <a name="module_kms"></a> [kms](#module\_kms) | terraform-ibm-modules/kms-all-inclusive/ibm | 4.11.2 |
...
| <a name="input_attachments"></a> [attachments](#input\_attachments) | scc attachments | <pre>list(object({<br>    name            = string<br>    profile_name    = string<br>    profile_version = string<br>    description     = string<br>    schedule        = optional(string, "daily")<br>    scope = optional(list(<br>      object({<br>        environment = optional(string, "ibm-cloud")<br>        properties = list(object({<br>          name  = string<br>          value = string<br>        }))<br>      })<br>    ))<br>  }))</pre> | `[]` | no |
